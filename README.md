<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=2E9EF7&height=200&section=header&text=Привет!%20Я%20Кирилл&fontSize=45&fontColor=ffffff&animation=fadeIn&desc=Python%20%7C%20JavaScript%20%7C%20C%23%20%7C%20Java&descAlignY=60" />
</p>

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=veinlegenda&style=flat-square&color=2E9EF7" alt="profile views"/>
</p>

<h3 align="center">20 лет, изучаю программирование и люблю доводить проекты до конца</h3>

<p align="center">
  <a href="https://vk.ru/veinlegenda"><img src="https://img.shields.io/badge/VK-0077FF?style=for-the-badge&logo=vk&logoColor=white" /></a>
...
Меня зовут Кирилл, мне 20 лет. Программирование — не только учёба, но и то, чем интересно заниматься: люблю разбираться, как всё устроено изнутри, и доводить задачи до рабочего результата.

Знаю `Python`, `JavaScript` и `C#`, сейчас углубляюсь в `Java`. Кроме кода — занимаюсь спортом, это про дисциплину и регулярность, которые точно так же работают и в обучении.

- 💻 Пишу на Python, JavaScript, C#
- 📖 Сейчас изучаю Java
- 🏋️ Спорт — для концентрации и дисциплины
- 🌱 Открыт к обучению и совместным проектам
